...
def send_register_email(email, send_type='register'):
    ...
    if send_type == 'register':
        ...
        email_title = '驴友在线网密码重置链接'
        email_body = '请点击下面的链接重置你的密码：' \
                     'http://127.0.0.1:8000/reset/{0}' \
                     '\n（如果是线上环境，请点击下面的链接激活你的账号: http://101.200.46.167:8000/reset/{1}）'.format(code,code)
